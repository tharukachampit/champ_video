...
public class SwiftChampVideoPlugin: NSObject, FlutterPlugin {
 var channel : FlutterMethodChannel?
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "com.plugin.champsoft/champ_video", binaryMessenger: registrar.messenger())
    let instance = SwiftChampVideoPlugin()
